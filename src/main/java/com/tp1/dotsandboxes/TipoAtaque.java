...
public enum TipoAtaque {
    TIRO_NORMAL(1, 5, "imagens/MegaMan/ataques/tiroNormal.png", true, 
    true, 1, 15, 0, 0, 15, 15, 3, 15, 15, 0, 15, 15),
    TIRO_AZUL(2, 5, "imagens/MegaMan/ataques/tiroAzul.png", true, 
    ...
    false, 3, 28, 0, 0, 28, 32, 1, 28, 34, 0, 28, 32),
